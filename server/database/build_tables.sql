...
DROP TABLE IF EXISTS users,cook_info, cook_images, reviews,meals, meal_images CASCADE;
...
CREATE TABLE users(
  ...
  acc_created_at TIMESTAMP WITH TIME ZONE NOT NULL
);
