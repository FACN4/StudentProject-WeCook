...
class CheckoutForm extends Component {
  ...
  render() {
    ...
    const {
      basket,
      confirmationData: { data: userData }
    } = this.props;
      ...
      <React.Fragment>
        <FooterWrapper>
          ...
          <CheckoutWrapper>
            ...
            >
              {basket[firstMeal].mealInfo.meal_title}
            </MealCard>
            <H2>Payment</H2>
            ...
            <Address>{userData.delivery_house_no}</Address>{" "}
            <Address>{userData.delivery_post_code}</Address>
